...
import com.smoothstack.december.entity.Publisher;

public class PublisherDAO extends BaseDAO<Publisher> implements ResultSetExtractor<List<Publisher>> {

    public Integer createPublisher(String publisherName, String publisherAddress, String publisherPhone)
    ...
    public void updatePublisher(int publisherId, String publisherName, String publisherAddress, String publisherPhone)
            throws ClassNotFoundException, SQLException {
        super.mySQLTemplate.update(
    ...
    public void deletePublisher(int publisherId) throws ClassNotFoundException, SQLException {
        super.mySQLTemplate.update("DELETE FROM tbl_publisher WHERE publisherId = ?;", new Object[] { publisherId });
    }
